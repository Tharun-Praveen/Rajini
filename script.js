document.addEventListener('keydown', (event) => {
    ...
    if (key == 65) {
    	var audio = new Audio("Darbar ! BGM !.mp3");
        audio.currentTime = 0;
    	audio.play();
     ...
     if (key == 83) {
         var audio = new Audio("Darbar chumma kizhi.mp3");
         audio.currentTime = 0;
         audio.play();
     ...
     if (key == 68) {
         var audio = new Audio("Darbar Villain.mp3");
         audio.currentTime = 0;
         audio.play();
     ...
     if (key == 70) {
         var audio = new Audio("Darbar-Thani Vazhi.mp3");
         audio.currentTime = 0;
         audio.play();
     ...
     if (key == 71) {
         var audio = new Audio("Enthiran (1).mp3");
         audio.currentTime = 0;
         audio.play();
     ...
     if (key == 72) {
         var audio = new Audio("Enthiran 2 O.mp3");
         audio.currentTime = 0;
         audio.play();
     ...
     if (key == 74) {
         var audio = new Audio("Enthiran.mp3");
         audio.currentTime = 0;
         audio.play();
     ...
     if (key == 75) {
         var audio = new Audio("Petta - Bgm.mp3");
         audio.currentTime=0
         audio.play();
     ...
     if (key == 76) {
         var audio = new Audio("Petta - Marana Mass.mp3");
         audio.currentTime = 0;
         audio.play();
